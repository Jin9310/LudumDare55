...
####   KILL UPGRADES   ####
@export var auto_kill_base_timer: float = 10 #how fast the acolyes are killed automatically
...
####   MONEY
@export var usable_money: float = 0 #money that player currently have
####   MONEY UPGRADES   ####
